    ...
    while chromosome_states:
        ...
        for v in chromosome_states:
            ...
            chromosome_states_new.append(
                [chromosome_state[0][:pos] + v[0][pos:], chromosome_state[1][:pos] + v[1][pos:]])
            chromosome_states_new.append(
                [v[0][:pos] + chromosome_state[1][pos:], v[0][:pos] + chromosome_state[1][pos:]])
...
def mutation(chromosome_states):
    ...
    while n > 0:
        ...
        x = chromosome_state[0][:pos] + \
            str(int(not int(chromosome_state[0][pos]))
                ) + chromosome_state[0][pos+1:]
        y = chromosome_state[1][:pos] + \
            str(int(not int(chromosome_state[1][pos]))
...
if __name__ == '__main__':
    ...
    while n > 0:
        ...
        chromosome_states, top1_fitness_index = filter(
            chromosome_states, fitnesses)
        print '---------%d-----------' % n
