...
import random
import numpy as np
from traits.api import HasTraits, Float, Instance, Array, Int
from traitsui.api import Item, View, Handler
from enable.api import ComponentEditor, Component
from kiva.constants import PIXEL_MARKER
...
class AnimationDemo(HasTraits):
    ...
    def on_timer(self):
        ...
        self.points3d[:3, :] += 0.04 * \
            (self.target_points3d[:3, :] - self.points3d[:3, :])
